...
<head>
    ...
    <title>Fencing </title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<? echo base_url('assets/admin/') ?>images/favicon.png">
    <link href="<? echo base_url('assets/admin/') ?>css/style.css" rel="stylesheet">
