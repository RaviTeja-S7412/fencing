...
(3, 1, '[{\"module_id\":\"14\",\"sub_module_id\":[\"16\",\"18\",\"41\",\"42\",\"44\"]},{\"module_id\":\"13\",\"sub_module_id\":[\"25\"]},{\"module_id\":\"23\",\"sub_module_id\":null},{\"module_id\":\"25\",\"sub_module_id\":null},{\"module_id\":\"3\",\"sub_module_id\":null},{\"module_id\":\"21\",\"sub_module_id\":null},{\"module_id\":\"22\",\"sub_module_id\":null},{\"module_id\":\"12\",\"sub_module_id\":[\"4\",\"5\",\"9\"]},{\"module_id\":\"26\",\"sub_module_id\":null},{\"module_id\":\"20\",\"sub_module_id\":null},{\"module_id\":\"9\",\"sub_module_id\":[\"39\",\"40\"]},{\"module_id\":\"24\",\"sub_module_id\":null}]', '2022-03-12 13:56:49');
...
INSERT INTO `fdm_va_auths` (`id`, `agent_id`, `name`, `email`, `mobile_number`, `city`, `area`, `address`, `password`, `profile_pic`, `role`, `status`, `deleted`, `registered_date`, `last_logged_in`) VALUES
(1, '1', 'Super Admin', 'superadmin@fencing.com', 'superadmin@fencing.com', 0, 0, '', 'ecc4e152d4ba90a20316193b2b62eda6459b5fbac22eb6d60c2c2faf5dde4ce51e13ac1c9c6ed58759bacec720824cd257fd6ff6ed39e3669841a7b75ac4cfcfxVoDrEdokkavwke2HHR13gFHyTK/saQW', 'uploads/admin/profile/1234.jpg', 1, 'Active', 0, '2018-08-14 00:00:00', '2023-01-02 14:27:20');
...
(1, 'Fencing', 'fencing@gmail.com', 'Hyderabad\r\n', 9876543210, 0, 'Active');
...
(1, 'Header', 'uploads/general/logo/header/LOGO-01.png', 0, 'Active', '2022-03-26 20:31:25'),
...
--
-- Dumping data for table `fdm_va_social_networking`
--

INSERT INTO `fdm_va_social_networking` (`id`, `title`, `link`, `icon`, `deleted`, `status`, `created_date`, `updated_date`, `created_by`, `updated_by`) VALUES
(1, 'Linkedin', 'https://www.linkedin.com/authwall?trk=bf&trkInfo=AQEGG7iirk5skAAAAWdfhLloUM-hXMJe8aGX5rrb6rPW7m_1yC-xaMQG_mU--SLygNWuhMYymP4zwxcg-w21FbKjnPDUUWiuxo24d-DsQhzwXOduckquHcVzY_zUf8J6TXFQTso=&originalReferer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fcompany%2Ffreedom-bank', 'uploads/general/social_networking/242fad8e9b4cf99793d5fbf0b37563cf.png', 1, 'Inactive', '2018-09-25', '2018-11-29', 1, 1),
(2, 'Twitter', 'https://twitter.com/', 'fa fa-twitter', 0, 'Active', '2018-09-25', '2020-09-11', 1, 1),
(3, 'Facebook', 'https://www.facebook.com/', 'fa fa-facebook', 0, 'Active', '2018-09-25', '2020-09-11', 1, 1),
(4, 'Instagram', 'https://www.instagram.com/', 'fa fa-instagram', 0, 'Active', '2018-09-26', '2020-09-11', 1, 1),
(5, 'google plus', 'www.googleplus.com', 'fa fa-google-plus', 1, 'Inactive', '2019-01-06', '0000-00-00', 1, 0);
...
(1, 1, 'Create', 'agents/create-agent', '2018-08-19 18:30:00'),
(2, 1, 'View', 'agents/all-agents', '2018-08-19 18:30:00'),
(3, 2, 'Main Menu', 'menus/main-menu', '2018-09-24 18:30:00'),
(4, 12, 'Add Product', 'products/create-product', '2020-03-06 06:54:01'),
(5, 12, 'View Products', 'products', '2020-03-06 06:54:10'),
(6, 4, 'Static Pages', 'pages', '2019-01-05 18:30:00'),
(7, 4, 'Dynamic Pages', 'pages/dynamic-pages', '2019-01-05 18:30:00'),
...
(18, 14, 'Rejected Orders', 'orders/cancelled-orders', '2022-02-20 15:19:14'),
...
(25, 13, 'All Users', 'users', '2020-03-06 06:53:48'),
...
(39, 9, 'Create', 'vendors/createVendor', '2020-02-23 15:08:20'),
(40, 9, 'View', 'vendors', '2020-02-23 15:08:20'),
(41, 14, 'Offline Orders', 'orders/offline-orders', '2019-01-03 18:30:00'),
(42, 14, 'Confirmed Orders', 'orders/Activeorders/confirmedOrders', '2019-01-03 18:30:00'),
(44, 14, 'Out for Delivery Orders', 'orders/Activeorders/outOrders', '2022-02-20 15:09:36');
...
CREATE TABLE `orders` (
  ...
  `payment_gateway_charges` varchar(10) NOT NULL,
  ...
  `courier_service` int(11) NOT NULL,
...
CREATE TABLE `order_products` (
  ...
  `gst` int(11) NOT NULL,
  `pico_falls` int(11) NOT NULL,
  `blouse` int(11) NOT NULL,
...
CREATE TABLE `tbl_cart` (
  ...
  `falls_pico` varchar(25) NOT NULL,
  `blouse` varchar(25) NOT NULL,
  `date` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_categories` (`id`, `category_name`, `short_desc`, `image`, `link`, `status`, `created_date`, `updated_date`, `deleted`) VALUES
(5, 'POSTMASTER', '', 'uploads/categories/e5e3b354eaadac23282896b589d8f71c.png', 'postmaster', 'Active', '2023-01-02 11:03:29', '2023-01-02 05:33:29', 0),
(6, 'WOOD', '', 'uploads/categories/1bde5690864a574c1c509938b5e56111.png', 'wood', 'Active', '2023-01-02 11:08:48', '2023-01-02 05:38:48', 0),
(7, 'CHAIN LINK', '', 'uploads/categories/4331dc511600364fe0685ebd280a18d0.png', 'chain-link', 'Active', '2023-01-02 11:09:06', '2023-01-02 05:39:06', 0),
(8, 'VINYL', '', 'uploads/categories/f051e31312cb4888f1eaa6dfc2f860e7.png', 'vinyl', 'Active', '2023-01-02 15:03:40', '2023-01-02 09:33:40', 0);
...
CREATE TABLE `tbl_products` (
  ...
  `products_in_stock` int(5) NOT NULL DEFAULT 1,
  `product_actual_price` varchar(10) NOT NULL,
  `product_discount_price` double(10,2) NOT NULL,
...
INSERT INTO `tbl_products` (`id`, `product_id`, `hsn_code`, `gst_charges`, `product_name`, `product_category`, `sub_category`, `product_quantity`, `description`, `product_information`, `additional_information`, `link`, `mImages`, `brandname`, `target`, `location`, `product_image`, `product_banner_image`, `products_in_stock`, `product_actual_price`, `product_discount_price`, `status`, `qty_type`, `assigned_to`, `created_date`, `updated_date`, `deleted`, `sku`, `meta_desc`, `meta_keywords`) VALUES
(1, '', '', 0, 'P1', 5, 0, '', 'Lorem ipsum', 'Lorem ipsum', 'Lorem ipsum', 'p1', '[]', '', '', '', 'uploads/products/p5.png', '', 1, '1000', 800.00, 'Active', '', '', '2023-01-02 19:22:04', '2023-01-02 13:52:04', 0, 'SKU P!', '', ''),
(4, '', '', 0, 'P2', 6, 0, '', 'Lorem ipsum desc', 'Lorem ipsum product desc', 'Lorem ipsum additional desc', 'p2', '[\"uploads\\/products\\/multi\\/chainlink1.png\"]', '', '', '', 'uploads/products/chainlink.png', '', 1, '12000', 10000.00, 'Active', '', '', '2023-01-02 20:34:07', '2023-01-02 15:04:07', 0, 'SKU P2', '', '');
...
CREATE TABLE `tbl_users` (
  ...
  `address` text NOT NULL,
  `deliveryAddresses` text NOT NULL,
...
INSERT INTO `tbl_users` (`id`, `user_otp`, `username`, `email`, `mobile`, `password`, `address`, `deliveryAddresses`, `created_date`, `deleted`, `country`, `zipcode`, `status`) VALUES
(1, 0, '', 'sakaraviteja.s@gmail.com', '', '008530514459f7384141e6a6d2075b501957c0c0febeb6756f81637569c5fec8891568b65ee338572a10531104634185f6c5d820de6b2b414263bf53680f15b7AXRaSqaoGiO0NU0QgdhUgQ==', '', '', '0000-00-00 00:00:00', '0', '', '', '');
...
--
ALTER TABLE `fdm_va_modules`
  MODIFY `module_id` int(5) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `fdm_va_sub_modules`
  MODIFY `sub_module_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
